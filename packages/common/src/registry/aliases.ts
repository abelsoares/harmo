...
export const ALIASES: MetricAlias[] = [
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierHeartRateRecoveryOneMinute', metric: 'heart_rate_recovery_one_minute' },
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierWalkingDoubleSupportPercentage', metric: 'walking_double_support_percentage' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierWalkingAsymmetryPercentage', metric: 'walking_asymmetry_percentage' },
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierSixMinuteWalkTestDistance', metric: 'six_minute_walk_test_distance' },
  // === running form ===
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierRunningVerticalOscillation', metric: 'running_vertical_oscillation' },
  ...
  // === audio exposure ===
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierEnvironmentalAudioExposure', metric: 'environmental_audio_exposure' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierHeadphoneAudioExposure', metric: 'headphone_audio_exposure' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierEnvironmentalSoundReduction', metric: 'environmental_sound_reduction' },
  // === sleep ===
  { vendor: 'apple', alias: 'HKCategoryTypeIdentifierSleepAnalysis', metric: 'sleep_analysis' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierAppleSleepingBreathingDisturbances', metric: 'apple_sleeping_breathing_disturbances' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierAppleSleepingWristTemperature', metric: 'apple_sleeping_wrist_temperature' },
  // === environment / water ===
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierDietaryFatMonounsaturated', metric: 'dietary_fat_monounsaturated' },
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierDietaryFatPolyunsaturated', metric: 'dietary_fat_polyunsaturated' },
  ...
  { vendor: 'apple', alias: 'HKQuantityTypeIdentifierNumberOfAlcoholicBeverages', metric: 'number_of_alcoholic_beverages' },
